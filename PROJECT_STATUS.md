...
- Content: 12 stories in `src/assets/data/stories.json` — Lincoln (1), Kalam (2), Jobs (3), Oprah (4), Satyarthi (5), Murad (6), Malala (7), Yunus (8), Keller (9), Mandela (10), Grandin (11), Muhammad Ali (12). All follow the long-form narrative per `docs/daily-story-workflow.md`: reader-first "orator's plan" (assume zero prior knowledge; orient before conveying), 2,500–3,500 words, free-license images with credits, full sources. The legacy fixed-section fallback stays in the component for back-compat.
...
- Next steps:
  1. Next story: id 12 (12/1000) per `docs/daily-story-workflow.md` — reader-first from the first line
